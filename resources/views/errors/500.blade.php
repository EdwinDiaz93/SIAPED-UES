...
<html lang="es">
    <head>
        ...
        <title>{{ __('Error del servidor') }} - {{ config('app.name', 'SIAPED-UES') }}</title>
    ...
    <body>
        <div class="card">
            ...
            <h1>{{ __('Algo salió mal') }}</h1>
            <p>{{ __('Ocurrió un error inesperado en el servidor. Estamos trabajando para solucionarlo.') }}</p>
