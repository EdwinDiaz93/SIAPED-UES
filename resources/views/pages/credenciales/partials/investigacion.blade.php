    ...
    <div class="lg:col-span-1 p-4 border border-outline dark:border-outline-dark rounded-xl">
        ...
        <form wire:submit.prevent="guardarInvestigacion" class="flex flex-col gap-3">
            ...
            @include('pages.credenciales.partials.archivo-form', [
                'prefix'   => 'inv',
                'registro' => $inv_editando ? \App\Models\CredencialInvestigacion::find($inv_editando) : null,
            ])
                            ...
                            <td class="p-3 text-center whitespace-nowrap">
                                ...
                                @else
                                    @if ($r->estado !== 'aprobado')
                                        ...
                                        <button type="button" x-on:click="confirmAction('¿Eliminar?', () => $wire.eliminarInvestigacion({{ $r->id }}))" class="text-red-500 hover:text-red-700 cursor-pointer">✕</button>
                                    @else
